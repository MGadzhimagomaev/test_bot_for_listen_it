...
class YTstats:
    ...
    def _get_single_video_data(self, video_id, part):
        url = f"https://www.googleapis.com/youtube/v3/videos?part={part}&id={video_id}&key={self.google_api_key}"
        json_url = requests.get(url)
        data = json.loads(json_url.text)
        try:
    ...
    def dump(self):
        ...
        channel_title = self.video_data.popitem()[1].get('channelTitle', self.channel_id)#"ListenIT"
